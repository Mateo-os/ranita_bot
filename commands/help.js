...
async function help(message) {
    const infoE = new EmbedBuilder()
        ...
        .addFields(
            ...
            { name: `${prefix}checkseries`, value: "Muestra todos las cartas de la serie que escribas.", inline: false },
            ...
            { name: `${prefix}repeats`, value: "Muestra todas tus cartas con duplicados, o la del usuario que menciones.", inline: false },
